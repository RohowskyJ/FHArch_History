  ...
  <div class="bd">
    <ul class="navlist">
      <?php if (!empty($has['museen'])): ?>
        <li><a href="<?= $this->e($path2ROOT) ?>login/Core/Modules/Oeffentlichkeitsarbeit/MuseenList.php" target="M_Links" rel="noopener">
          <span>Museen & Sammlungen</span><span class="meta">Liste</span>
        </a></li>
      <?php endif; ?>

      <?php if (!empty($has['archive'])): ?>
        <li><a href="<?= $this->e($path2ROOT) ?>login/Core/Modules/Oeffentlichkeitsarbeit/ArLinkList.php" target="A_Links" rel="noopener">
          <span>Archive & Bibliotheken</span><span class="meta">Links</span>
        </a></li>
      <?php endif; ?>

      <?php if (!empty($has['termine'])): ?>
        <li><a href="<?= $this->e($path2ROOT) ?>login/Core/Modules/Oeffentlichkeitsarbeit/TerminList.php" target="Veranstalt" rel="noopener">
          <span>Veranstaltungen</span><span class="meta">Kalender</span>
        </a></li>
      <?php endif; ?>

      <?php if (!empty($has['presse'])): ?>
        <li><a href="<?= $this->e($path2ROOT) ?>login/Core/Modules/Oeffentlichkeitsarbeit/PresseList.php" target="Presse" rel="noopener">
          <span>Presse-Information</span><span class="meta">Spiegel</span>
        </a></li>
      <?php endif; ?>

      <?php if (!empty($has['buch'])): ?>
        <li><a href="<?= $this->e($path2ROOT) ?>login/Core/Modules/Oeffentlichkeitsarbeit/BuchList.php" target="Buch" rel="noopener">
          <span>Buch-Besprechungen</span><span class="meta">Rezensionen</span>
        </a></li>
      <?php endif; ?>

      <?php if (!empty($has['markt'])): ?>
        <li><a href="<?= $this->e($path2ROOT) ?>login/Core/Modules/Oeffentlichkeitsarbeit/MarktplList.php" target="Marktpl" rel="noopener">
