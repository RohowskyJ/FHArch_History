...
<section class="hero reveal" aria-label="Einführung">
  <div class="hero-inner">
    <div class="hero-copy">
      ...
      <h3>Geschichte bewahren. Wissen teilen. Feuerwehrkultur dokumentieren.</h3>
      <p>
      ...
      <div class="hero-actions">
        ...
        <a class="btn" href="<?= $this->e($path2ROOT) ?>VFH/login.php">
          Login intern
          <span aria-hidden="true">↗</span>
        </a>
      </div>
      ...
      <?php if (!$configOk): ?>
        <div style="margin-top:16px" class="notice">
          ...
          <code>ConfigLib_d_<?= $this->e($SI ?? '') ?>.ini</code>, <code>config_s_<?= $this->e($SI ?? '') ?>.ini</code>.
        </div>
      <?php endif; ?>
    </div>
  ...
  <div class="hero-copy">
     <div class="hero-actions">
        ...
        <a href="#" class="btn ajax-load" data-page="ziele">Details zu den Zielen</a>
      </div>
