...
<?php if (!empty($has['FzgGer'])): ?>   
       ...
       <div class="Menu-Line">
           <a href="../Modules/FahrzeugeGeraete/FZGerVerw.php" target="F-Verwaltung">Fahrzeug und Geräte- Verwaltung</a>
       </div>    
<?php endif; ?>
...
<?php else: ?>
    <?php if (!empty($has['Archiv'])): ?>   
         ...
         <div class="Menu-Line">
             <a href="../Modules/Archivalien/ArchivVerw.php" target="Archiv">Archivalien- Verwaltung</a>
         </div>  
    <?php endif; ?>
    <?php if (!empty($has['Foto'])): ?>   
       ...
       <div class="Menu-Line">
           <a href="../Modules/Fotografie/FotoVerw.php" target="Foto">Medien- Verwaltung und Berichte</a>
       </div>  
    <?php endif; ?>
    <?php if (!empty($has['Inventar'])): ?>  
       ...
       <div class="Menu-Line">
           <a href="../Modules/Inventar/InventVerw.php" target="Invent">Inventar- Verwaltung</a>
       </div>   
    <?php endif; ?>
    <?php if (!empty($has['Doku'])): ?>   
       ...
       <div class="Menu-Line">
           <a href="../Modules/Oeffentlichkeitsarbeit/DokuVerw.php" target="Doku">Dokumentationen</a>
       </div>  
    <?php endif; ?>
    <?php if (!empty($has['Archiv'])): ?>   
    <?php endif; ?>
...
<?php if (!empty($has['PSA'])): ?>  
       ...
       <div class="Menu-Line">
           <a href=$path2ROOT . "FS_PS_Info_Ausz_Abz.php" target="Info_R4">Auszeichnungen, Ärmelabzeichen, Wappen - DA 1.5.3, Uniformen, Heraldik</a>
       </div> 
<?php endif; ?>
<!--  
<div class="Menu-Separator">Referat 2 - Fahrzeuge und Geräte, mit Muskel oder Motor bewegt, Beschreibungen</div>
...
<div class="Menu-Separator" style="margin-top: 48px;">
    <a href="../../../VFH/logout.php">LOGOFF (HomePage)</a>
</div>