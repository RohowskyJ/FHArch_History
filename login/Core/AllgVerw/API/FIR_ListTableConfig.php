...
ini_set('error_log', "FirmenTableConfig_php-error.log.txt");

class FIR_ListTableConfig {
    /**
    ...
    private static string $logFile = "BenutzerTableConfig_debug.log.txt";
    ...
    public static function getColumns(string $listType, PDO $pdo): array {
        ...
        switch ($listType) {     
            ...
            case "AUFB":
            case "GER":
                $showCols = [ "fi_id", "fi_abk", "fi_name", "fi_ort",'fi_vorgänger', 'fi_branche', 'fi_funkt', 'fi_inet'];
