...
ini_set('error_log', __DIR__ . '/ABK_API_php-error.log.txt');
...
use Fharch\Core\AllgVerw\API\ABK_ListRepository;
use Fharch\Core\AllgVerw\API\ABK_ListTableConfig;
...
try {
    ...
    $pdo = $DBD->getPDO();
    $repo = new ABK_ListRepository($pdo);
    ...
    $columns = ABK_ListTableConfig::getColumns($listType, $pdo);
