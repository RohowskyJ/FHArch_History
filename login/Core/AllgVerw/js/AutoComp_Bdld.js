/** Autocomplete für Bundesland- Kurzzeichen mit jq-ui-ajax  */
function initBdldAutocomplete(selector) {
	const debug = window.location.search.includes('debug=1') || $(selector).data('debug') === 1 || $(selector).data('debug') === '1';
	const apiUrl = '../../AllgVerw/API/BdldAutoComp_API.php';
...
$(function() {
	console.log('dbld auto ');
    initBdldAutocomplete('#bdld');
});