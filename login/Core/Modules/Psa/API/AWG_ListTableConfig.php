...
ini_set('error_log', "../../../../login/AOrd_Verz/logging/AWG_TableConfig_php-error.log.txt");

class AWG_ListTableConfig {
    /**
    ...
    private static string $logFile = "../../../../login/AOrd_Verz/logging/AWG_TableConfig_debug.log.txt";
    ...
    public static function getColumns(string $listType, PDO $pdo): array {
        ...
        switch ($listType) { 
            ...
            default: 
                $showCols = ["fo_id", "fo_fw_id", "fo_gde_komment", "fo_gde_wappen"];
        }
