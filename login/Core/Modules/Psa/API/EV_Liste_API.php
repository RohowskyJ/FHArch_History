...
ini_set('error_log', __DIR__ . '../../../../login/AOrd_Verz/Logging/EV_Liste_API_php-error.log.txt');
...
register_shutdown_function(function() {
    ...
    if ($error !== null) {
        ...
        file_put_contents(__DIR__ . '../../../../login/AOrd_Verz/Logging/EV_Liste_fatal_error.log', $message, FILE_APPEND);
    }
});
...
use Fharch\Core\Modules\Psa\API\EV_ListRepository;
use Fharch\Core\Modules\Psa\API\EV_ListTableConfig;

require_once 'EV_ListRepository.php';
require_once 'EV_ListTableConfig.php';
...
try {
    ...
    $repo = new EV_ListRepository($pdo);
  
    
    // Debug-Ausgabe als Log, nicht als EV_dump
    ...
    $columns = EV_ListTableConfig::getColumns($listType, $pdo);
