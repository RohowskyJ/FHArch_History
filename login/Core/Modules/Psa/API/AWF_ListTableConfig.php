...
ini_set('error_log', "AWF_TableConfig_php-error.log.txt");

class AWF_ListTableConfig {
    /**
    ...
    private static string $logFile = "../../../../login/AOrd_Verz/Logging/AWF_TableConfig_debug.log.txt";
    ...
    public static function getColumns(string $listType, PDO $pdo): array {
        ...
        $colsByTable = $meta->getColumnsForTables(["psw_ff_wappen"]);
        ...
        switch ($listType) { 
            ...
            default: 
                $showCols = ["fo_id", "fo_fw_id", "fo_w_komm", "fo_ff_wappen"];
        }
