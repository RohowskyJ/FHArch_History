...
ini_set('error_log', __DIR__ . '../../../../login/AOrd_Verz/Logging/AWG_Liste_API_php-error.log.txt');
...
register_shutdown_function(function() {
    ...
    if ($error !== null) {
        ...
        file_put_contents(__DIR__ . '../../../../login/AOrd_Verz/Logging/AWG_Liste_fatal_error.log', $message, FILE_APPEND);
    }
});
...
use Fharch\Core\Modules\Psa\API\AWG_ListRepository;
use Fharch\Core\Modules\Psa\API\AWG_ListTableConfig;

require_once 'AWG_ListRepository.php';
require_once 'AWG_ListTableConfig.php';
...
try {
    ...
    $repo = new AWG_ListRepository($pdo);
  
    
    // Debug-Ausgabe als Log, nicht als AWG_dump
    ...
    $columns = AWG_ListTableConfig::getColumns($listType, $pdo);
