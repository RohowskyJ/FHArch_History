 ...
 *
 */
class AWG_ListRepository {
    private PDO $pdo;
    protected static string $logFile = '../../../../login/AOrd_Verz/Logging/AWG_ListRepository_debug.log.txt';
    /*
    ...
    */
    ...
    public function getAermAbz(string $listType, string $fo_fw_id, ?string $search = null) : array {
        $sql = "SELECT * FROM psw_ort_wappen ";
        $where = [];
        $params = [];
