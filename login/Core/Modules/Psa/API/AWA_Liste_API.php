...
ini_set('error_log', __DIR__ . '../../../../login/AOrd_Verz/Logging/AWA_Liste_API_php-error.log.txt');
...
register_shutdown_function(function() {
    ...
    if ($error !== null) {
        ...
        file_put_contents(__DIR__ . '/AWA_Liste_fatal_error.log', $message, FILE_APPEND);
    }
});
...
use Fharch\Core\Modules\Psa\API\AWA_ListRepository;
use Fharch\Core\Modules\Psa\API\AWA_ListTableConfig;

require_once 'AWA_ListRepository.php';
require_once 'AWA_ListTableConfig.php';
...
try {
    ...
    $repo = new AWA_ListRepository($pdo);
  
    
    // Debug-Ausgabe als Log, nicht als AWA_dump
    ...
    $columns = AWA_ListTableConfig::getColumns($listType, $pdo);
