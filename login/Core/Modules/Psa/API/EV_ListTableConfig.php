...
ini_set('error_log', "../../../../login/AOrd_Verz/Logging/EV_TableConfig_php-error.log.txt");

class EV_ListTableConfig {
    /**
    ...
    private static string $logFile = "../../../../login/AOrd_Verz/Logging/EV_TableConfig_debug.log.txt";
