...
ini_set('error_log', "../../../../login/AOrd_Verz/Logging/EL_TableConfig_php-error.log.txt");

class EL_ListTableConfig {
    /**
    ...
    private static string $logFile = "../../../../login/AOrd_Verz/Logging/EL_TableConfig_debug.log.txt";
