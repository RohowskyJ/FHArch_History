...
ini_set('error_log', __DIR__ . '/PR_LinkList_php-error.log.txt');
# var_dump($_SERVER);
...
# Haeder ausgeben
# ===========================================================================================================
$ListHead = "Presse- Informationen";
$title = "Presse- Informatione";

$TABUcss = true;
HTML_header('Presse- Informationen', $header, 'Admin', '80em'); # Parm: Titel,Subtitel,HeaderLine,Type,width
...
$lTitel = ["Alle" => "Alle Ausschnitte  "];

$NeuRec = "";
if (isset($_SESSION['BS_Prim']['BE'])) {
    $NeuRec = " &nbsp; &nbsp; &nbsp; <a href='PresseEdit.php?ID=0' > Neuen Datensatz anlegen </a>";
} else {
    $lTitel = ["Alle." => "Alle Auschnitte "];
}
