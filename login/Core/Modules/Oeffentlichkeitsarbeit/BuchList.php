...
ini_set('error_log', __DIR__ . '/BU_LinkList_php-error.log.txt');
# var_dump($_SERVER);
...
if (!$ber) {
    header("Location $path2ROOT/pVFH/");
}
...
# Haeder ausgeben
# ===========================================================================================================
$ListHead = "Buchbesprechungen";
$title = "Buchbesprechungen";

$TABUcss = true;
HTML_header('Buchbesprechungen', $header, 'Admin', '80em'); # Parm: Titel,Subtitel,HeaderLine,Type,width
...
$list_ID = 'BU';
$lTitel = ["Alle" => "Alle verfügbaren Bücher "];
if ($_SESSION['BS_Prim']['Mod']['smod'] == 'index') {
    $lTitel = ["Extern" => "Alle. verfügbaren Bücher "];
}

$NeuRec = "";
if ($_SESSION['BS_Prim']['Mod'] == 'Menu') {
    $NeuRec = " &nbsp; &nbsp; &nbsp; <a href='ArLinkEdit.php?ID=0' > Neuen Datensatz anlegen </a>";
}
