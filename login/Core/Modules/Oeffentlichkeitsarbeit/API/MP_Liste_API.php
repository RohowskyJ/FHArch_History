...
ini_set('error_log', __DIR__ . '/MP_Liste_API_php-error.log.txt');
...
use Fharch\Core\Modules\Oeffentlichkeitsarbeit\API\MP_ListRepository;
use Fharch\Core\Modules\Oeffentlichkeitsarbeit\API\MP_ListTableConfig;
...
try {
    ...
    $pdo = $dbLogger->getPDO();
    $repo = new MP_ListRepository($pdo);
