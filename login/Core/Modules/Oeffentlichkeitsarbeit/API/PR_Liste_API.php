...
ini_set('error_log', __DIR__ . '/PR_Liste_API_php-error.log.txt');
...
use Fharch\Core\Modules\Oeffentlichkeitsarbeit\API\PR_ListRepository;
use Fharch\Core\Modules\Oeffentlichkeitsarbeit\API\PR_ListTableConfig;
...
try {
    ...
    $pdo = $dbLogger->getPDO();
    $repo = new PR_ListRepository($pdo);
