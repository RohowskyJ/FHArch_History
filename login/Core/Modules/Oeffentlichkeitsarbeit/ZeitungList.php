...
ini_set('error_log', __DIR__ . '/ZT_LinkList_php-error.log.txt');
# var_dump($_SERVER);
...
$TABUcss = true;
HTML_header('Zeitungsen', $header, 'Admin', '80em'); # Parm: Titel,Subtitel,HeaderLine,Type,width
...
$lTitel = ["Alle" => "Alle Zeitungen "];

$NeuRec = "";
if (isset($_SESSION['BS_Prim']['BE'])) {
    $NeuRec = " &nbsp; &nbsp; &nbsp; <a href='ZeitungenEdit.php?ID=0' > Neuen Datensatz anlegen </a>";
} else {
    $lTitel = ["Alle." => "Alle Zeitungen"];
}
