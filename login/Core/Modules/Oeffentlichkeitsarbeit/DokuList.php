...
ini_set('error_log', __DIR__ . '/DO_LinkList_php-error.log.txt');
# var_dump($_SERVER);
...
# Haeder ausgeben
# ===========================================================================================================
$ListHead = "Dokumentationen des Vereines";
$title = "Dokumentationen des Vereines";

$TABUcss = true;
HTML_header('Dokumentationen des Vereines', $header, 'Admin', '80em'); # Parm: Titel,Subtitel,HeaderLine,Type,width
...
$list_ID = 'DO';
$lTitel = ["Alle" => "Alle verfügbaren Dokumente"];

$NeuRec = "";
if (isset($_SESSION['BS_Prim']['BE'])) {
    $NeuRec = " &nbsp; &nbsp; &nbsp; <a href='DokuEdit.php?ID=0' > Neuen Datensatz anlegen </a>";
} else {
    $lTitel = ["Alle." => "Alle verfügbaren Dokumente"];
}
