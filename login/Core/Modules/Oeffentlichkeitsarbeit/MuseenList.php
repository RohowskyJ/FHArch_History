...
ini_set('error_log', __DIR__ . '/MU_LinkList_php-error.log.txt');
# var_dump($_SERVER);
...
HTML_header('Museen', $header, 'Admin', '80em'); # Parm: Titel,Subtitel,HeaderLine,Type,width
...
$list_ID = 'MU';
$lTitel = ["Alle" => "Alle bekannten Museen anzeigen",
