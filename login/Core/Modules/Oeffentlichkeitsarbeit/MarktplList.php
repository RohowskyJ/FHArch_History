...
ini_set('error_log', __DIR__ . '/MP_LinkList_php-error.log.txt');
# var_dump($_SERVER);
...
# Haeder ausgeben
# ===========================================================================================================
$ListHead = "Biete / Suche - Marktplatz";
$title = "Biete/Suche";

$TABUcss = true;
HTML_header('Biete/Suche - Marktplatz', $header, 'Admin', '80em'); # Parm: Titel,Subtitel,HeaderLine,Type,width
...
$lTitel = ["Alle" => "Alle Gebote "];

$NeuRec = "";
if (isset($_SESSION['BS_Prim']['BE'])) {
    $NeuRec = " &nbsp; &nbsp; &nbsp; <a href='MarktplEdit.php?ID=0' > Neuen Datensatz anlegen </a>";
} else {
    $lTitel = ["Alle." => "Alle Gebote"];
}
