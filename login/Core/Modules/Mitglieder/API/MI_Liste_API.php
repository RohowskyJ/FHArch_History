...
ini_set('error_log', __DIR__ . '/MI_Liste_API_php-error.log.txt');
...
register_shutdown_function(function() {
    ...
    use Fharch\Core\Modules\Mitglieder\API\MI_MemberRepository;
    use Fharch\Core\Modules\Mitglieder\API\MI_MemberTableConfig;
...
try {
    ...
    $pdo = $DBD->getPDO();
    $repo = new MI_MemberRepository($pdo);
