...
ini_set('error_log', __DIR__ . '/UN_ListeAPI_php-error.log.txt');
...
use Fharch\Core\Modules\Mitglieder\API\UN_ListeRepository;
use Fharch\Core\Modules\Mitglieder\API\UN_ListeTableConfig;
...
try {
    ...
    $repo = new UN_ListeRepository($pdo);
    ...
    $data = $repo->getUnterst($listType, $search);
    $columns = UN_ListeTableConfig::getColumns($listType, $pdo);
