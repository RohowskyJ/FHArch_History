...
if (!class_exists(\FSArch\Login\Basis\RO_ListeRepository::class)) {
    require_once __DIR__ . '/RO_ListeRepository';
}
if (!class_exists(\FSArch\Login\Basis\RO_ListeTableConfig::class)) {
     require_once __DIR__ . '/RO_ListeTableConfig';
}
