...
ini_set('error_log', __DIR__ . '/AR_Liste_API_php-error.log.txt');
...
register_shutdown_function(function() {
    ...
    if ($error !== null) {
        ...
        file_put_contents(__DIR__ . '/AR_Liste_fatal_error.log', $message, FILE_APPEND);
    }
});
...
use Fharch\Core\Modules\Oeffentlichkeitsarbeit\API\AR_ListRepository;
use Fharch\Core\Modules\Oeffentlichkeitsarbeit\API\AR_ListTableConfig;
...
try {
    ...
    $pdo = $dbLogger->getPDO();
    $repo = new AR_ListRepository($pdo);
